...
```bash
docker build https://github.com/sablierapp/sablier.git#v1.8.6:plugins/caddy -t caddy:with-sablier
```

**Note:** You can change `main` for any other branch (such as `beta`, or tags `v1.8.6`)
