...
require (
	...
	github.com/testcontainers/testcontainers-go/modules/dind v0.38.0 // Waiting for fix to be released on v0.36.1
...
require github.com/containers/image/v5 v5.36.0
...
require (
	...
	github.com/hashicorp/nomad/api v0.0.0-20250730140228-5dc7e7fe2583 // indirect
