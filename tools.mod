...
require github.com/codesenberg/bombardier v1.2.6
...
require (
	...
	github.com/Zxilly/go-size-analyzer v1.13.0 // indirect
	github.com/ZxillyFork/gore v0.0.0-20260517104207-c177b8d9fc9c // indirect
